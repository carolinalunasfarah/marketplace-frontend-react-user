        ...
        <Row className="w-100 mx-1 mx-lg-4 gap-4 d-flex justify-content-center">
          ...
          <Col className="bg-white rounded-4 box-shadow col-md-7 form-signin px-4">
            <Form onSubmit={handleSubmit}>
              ...
              <Button
                className="col-12 btn py-3 btn-primary text-white fw-bold shadow-lg my-5"
                type="submit">
                Pagar Ahora
              </Button>
            </Form>
          ...
          <Col className=" bg-white rounded-4 box-shadow col-md-4 px-4">
            ...
            {cart.items?.map(
              (product, index) =>
                product && (
                  <div key={index} className="pb-4 d-flex gap-4">
                    ...
                    <div className="position-relative d-inline-block">
                      ...
                      <Image
                        ...
                        alt={product.name}
                        className="rounded mb-3 box-shadow"
                        width="100"
                      />
                    </div>
                   <div>
